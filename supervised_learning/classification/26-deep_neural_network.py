#!/usr/bin/env python3
"""
defines a DeepNeuralNetwork class that defines
...
class DeepNeuralNetwork:
    ...
    def __init__(self, nx, layers):
        ...
        parameters:
            ...
            layers [list]: representing the number of nodes in each layer
                ...
                If elements in layers are not all positive integers,
                    raise a TypeError.
    ...
    def weights(self):
        ...
        __weights hold all the wrights and biases of the network
        """
    ...
    def cost(self, Y, A):
        ...
        logistic regression loss function:
            ...
            To avoid log(0) errors, use (1.0000001 - A) instead of (1 - A)
        logistic regression cost function:
            cost = (1 / m) * sum of loss function for all m examples
    ...
    def gradient_descent(self, Y, cache, alpha=0.05):
        ...
        derivative of A with respect to z:
            dz = A * (1 - A)
        combining the two above with chain rule,
        derivative of loss function with respect to z:
            dz = A - Y
        using chain rule with the derivative above,
        ...
        parameters:
            ...
            verbose [boolean]:
                ...
                If True, prints "Cost after {iteration} iterations: {cost}
                    after every step iteration,
                    includes data from the 0th and the last iteration
            graph [boolean]:
                defines whether or not to graph information about training
                If True, plots the training data every step iteration:
                    Training data is shown as a blue line,
                    X-axis is labelled as "iteration",
                    Y-axis is labelled as "cost",
            ...
            step [int]: the number of iterations between printing verbose info
                    of plotting a graph data point
    ...
    def save(self, filename):
        ...
        parameters:
            filename [string]: file to save the object to
                If the filename does not have the extension .pkl, add it.
        """
        import pickle
    ...
    def load(filename):
        ...
        returns:
            the loaded object,
                or None if the filename doesn't exist
        """
        import pickle
        try:
