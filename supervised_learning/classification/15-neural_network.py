#!/usr/bin/env python3
"""
defines a NeuralNetwork class that defines
...
class NeuralNetwork:
    """
    A class that represents a neural network with one hidden layer
    performing binary classification
    ...
    def __init__(self, nx, nodes):
        ...
        sets private instance attributes:
            __W1: the weights vector for the hidden layer,
                initialised using a random normal distribution
            __b1: the bias for the hidden layer,
                initialised with 0s
            __A1: the activated output for the hidden layer,
                initialised to 0
